...
class DPCNNMetaWorldWorkspace(BaseWorkspace):
    """
    Diffusion Policy CNN workspace for MetaWorld environments.
    ...
    diffusion policy specific training and evaluation logic.
    """
    ...
    def setup_agent(self, device: str = "cuda") -> None:
        """Initialize the diffusion policy agent."""
        ...
        print(f"Initialized diffusion policy agent on device: {device}")
    ...
    def train(
        ...
        """
        Main training loop for the diffusion policy.
        ...
        for epoch in range(num_epochs):
            ...
            if epoch % test_every == 0:
                print(f"\nTesting agent in environment (epoch {epoch})...")
