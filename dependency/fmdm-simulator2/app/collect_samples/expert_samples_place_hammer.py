...
sample_folder = '/home/jun/gato_data/downstream_task/place_hammer/'
...
if __name__ == '__main__':
    ...
    env = gym.make('place_hammer-v0', config_file=os.environ['path-to-configs'] + 'place_hammer.yaml')
    ...
    for m in range(EPISODES):
        ...
        for i in range(NUM_STEPS):
            ...
            print('==place Hammer eps collected {:3d} {:4d}/{}, Duration: {:2.3f}s, Total time spent: {:4.1f}, step {}/{}'.format(
                eps_collected, m + 1,
                EPISODES, time.monotonic() - step_s, time.monotonic() - s, i, NUM_STEPS))
            if done and i+1>30:
                print('==place Hammer eps finished in {} steps'.format(i+1))
                eps_collected += 1
