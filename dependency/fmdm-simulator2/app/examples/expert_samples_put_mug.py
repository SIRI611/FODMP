...
sample_folder = '/home/jun/gato_data/downstream_task/put_mug/'
...
if __name__ == '__main__':
    ...
    env = gym.make('put_mug-v0', config_file=os.environ['path-to-configs'] + 'put_mug.yaml')
    ...
    for m in range(EPISODES):
        ...
        for i in range(NUM_STEPS):
            ...
            print('==put mug eps collected {:3d} {:4d}/{}, step {:4d}/{}, action: ['.format(eps_collected, m+1, EPISODES, i, NUM_STEPS), end='')
            for k in action:
